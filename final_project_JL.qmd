...
After the data has been collected, the COVID-19 waves were identified by COVID-19 cases and COVID-19 deaths making a ‘hump’ shape together. After identifying the COVID-19 waves, the death rate of COVID-19 per 100,000 people for each state was calculated by taking the number of covid deaths divided by the population of each state and multiplying it by 100,000 for each week from 2020 to 2023 and the virulence of COVID-19 was calculated by finding the case rate of COVID-19 per 100,000 for each state. The COVID-19 case rate (per 100,000 people) was calculated by dividing the number of COVID-19 cases for each state by the population and multiplying it by 100,000.
